...
城市升级新增城市现场、免登录关注、日历订阅、更新动态和可读的静态详情页。完整本地启动、合成后台、受限维护候选、退出进程恢复与封包说明见 [本地运行与维护](docs/CITY-UPGRADE-LOCAL.md)。本轮没有部署服务器。
...
页面主导航为发现、团体、演出、全国地图、风格图与观演指南，页脚保留邮件投稿纠错和关于入口。团体列表与独立档案使用轻量公开索引；`group.html?group=g001` 进入独立档案，旧 `index.html?group=g001` 仍可定位原图表。完整399条保留，历史条目可从全部档案访问。演出默认显示今天及未来的已收录资料，`period=past|all` 可看往期或全部，旧日期查询和活动锚点继续可用。活动为人工核验的部分收录，非实时全国排期；“尚未收录”不代表没有活动。

独立的 [`geography.html`](geography.html) 按主要活动城市展示团体，可切换建团城市、筛选省市或搜索团名，并缩放至城市聚合点打开团体名单。它沿用公开团体索引与存续口径；全国团体数按 ID 去重，跨城市的地域出现次数单独统计，未知城市进入未定位名单。同城团体共享城市参考坐标，不表示场馆或具体活动地址。原风格图继续呈现粉丝量与风格关系。
